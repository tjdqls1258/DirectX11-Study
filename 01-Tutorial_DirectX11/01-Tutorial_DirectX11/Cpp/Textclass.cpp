	...
	D3DXMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, "../01-Tutorial_DirectX11/Data/fontdata.txt", L"../01-Tutorial_DirectX11/Data/font.dds");
	if (!result)
	{
	...
	result = UpdateSentence(m_sentence1, "Hello", 200, 100, 0.0f, 0.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
